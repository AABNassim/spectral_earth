...
from ..datasets.enmap_treemap import EnMAPTreeMapDataset


class EnMAPTreeMapDataModule(NonGeoDataModule):
    """
    LightningDataModule for the EnMAP-TreeMap dataset.
    """
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """
        super().__init__(EnMAPTreeMapDataset, batch_size, num_workers, **kwargs)
